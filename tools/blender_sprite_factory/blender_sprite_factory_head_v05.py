...
PREVIOUS_HEAD_PROFILE_PATH = SCRIPT_DIR / "head_profile_v04.py"
ACTIVE_HEAD_PROFILE_PATH = SCRIPT_DIR / "head_profile_v05.py"
...
def _register_box(
    ...
    factory._register(
        ...
        factory._box(
            ...
            rotation=(
                0.0,
                math.radians(part.rotation_y_degrees),
                0.0,
            ),
        ),
        module_id,
...
def _build_head_and_hair_v05(context: factory.BuildContext) -> None:
    head = context.head
    detail = load_head_detail_profile_v05(context.config.character_id)
...
def main() -> int:
    factory.load_head_profile = load_head_profile_v05
    factory._build_head_and_hair = _build_head_and_hair_v05
    factory._write_run_manifest = _write_run_manifest_v05
    return factory.main()
