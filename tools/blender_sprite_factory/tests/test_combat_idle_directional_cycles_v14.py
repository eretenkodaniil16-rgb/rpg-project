...
class CombatIdleDirectionalCyclesV14Tests(unittest.TestCase):
    ...
    def test_v14_remains_artist_approved_source_under_active_v16(self) -> None:
        ...
        self.assertIn(
            "render-combat-idle-directional-cycles-v14 (artist-approved four-direction combat idle cycles)",
            workflow,
        )
        self.assertIn(
