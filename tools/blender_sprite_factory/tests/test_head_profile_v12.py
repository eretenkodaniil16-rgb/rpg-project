...
from head_profile_v12 import HUMAN_WARRIOR_M01_HEAD_V12, load_head_profile_v12


class HeadProfileV12Tests(unittest.TestCase):
    def test_revision_advances_without_changing_locked_head_or_face_geometry(self) -> None:
        profile = load_head_profile_v12("human_warrior_m01")
        ...
        for field_name in (
            ...
            self.assertEqual(
                ...
                getattr(HUMAN_WARRIOR_M01_HEAD_V11, field_name),
            )
        self.assertIs(profile, HUMAN_WARRIOR_M01_HEAD_V12)

    def test_unknown_character_is_rejected(self) -> None:
        with self.assertRaises(KeyError):
            load_head_profile_v12("unknown")
