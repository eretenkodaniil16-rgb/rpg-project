...
class AttackSwordDirectionalCycleV21Pass07Tests(unittest.TestCase):
    @classmethod
    ...
    def test_diagnostic_contract(self) -> None:
        self.assertEqual(CORRECTION_PASS, "v21_pass07")
        self.assertEqual(
            TWOHAND_LEFT_ARM_REVISION,
    ...
    def test_pass07_is_preserved_while_pass09_is_active(self) -> None:
        active = (
