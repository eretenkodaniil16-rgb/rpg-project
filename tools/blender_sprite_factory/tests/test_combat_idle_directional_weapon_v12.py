...
class CombatIdleDirectionalWeaponV12Tests(unittest.TestCase):
    ...
    def test_corrected_onehand_frames_must_clear_boundaries_and_width_budget(self) -> None:
        ...
        self.assertIn(
            "onehand_corrected_frames_clear_canvas_boundaries",
            self.adapter_source,
        )
        self.assertIn(
            "corrected_directional_static_candidates_require_manual_review",
            self.adapter_source,
        )

    def test_v12_is_artist_approved_static_source_for_v14(self) -> None:
        ...
        self.assertIn(
            "render-combat-idle-directional-weapon-v12 (artist-approved directional static source)",
            workflow,
        )
        self.assertIn(
