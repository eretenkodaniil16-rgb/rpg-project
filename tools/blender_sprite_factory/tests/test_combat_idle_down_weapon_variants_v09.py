...
from combat_idle_down_weapon_variants_profile_v08 import HUMAN_WARRIOR_M01_WEAPON_STANCES_V08
...
class CombatIdleDownWeaponVariantsV09Tests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.builder_source = (cls.tool_root / "combat_idle_down_weapon_variants_builder_v09.py").read_text(encoding="utf-8")
        cls.adapter_source = (cls.tool_root / "blender_sprite_factory_combat_idle_down_weapon_variants_v09.py").read_text(encoding="utf-8")

    def test_only_one_hand_variants_advance_to_v09(self) -> None:
        self.assertEqual(self.profile.revision, "v09")
        self.assertEqual(tuple(item.animation_id for item in self.profile.variants), (
    ...
    def test_builder_adds_only_pose_fitted_one_hand_v09_modules(self) -> None:
        ...
        self.assertIn("previous_builder.create_weapon_stance_actions_v08(context)", self.builder_source)
        ...
        self.assertIn("(ONE_HAND_SIDE_X, ONE_HAND_BEHIND_Y, ONE_HAND_DOWN_Z)", self.builder_source)
        self.assertIn("combat_idle_one_hand_v08_rejected_for_cross_torso_projection", self.builder_source)
    ...
    def test_adapter_reuses_exact_v06_two_hand_actions_and_modules(self) -> None:
        ...
        self.assertIn("blade_projected_across_lower_torso_instead_of_outward_side", self.adapter_source)
        self.assertIn("one_hand_blade_physical_right_outward_and_partly_behind", self.adapter_source)
        self.assertNotIn("scale.x = -1", self.adapter_source)

    def test_v09_remains_selected_static_source_under_v13(self) -> None:
        ...
        self.assertIn("Selected static source adapter: blender_sprite_factory_combat_idle_down_weapon_variants_v09.py", launcher)
