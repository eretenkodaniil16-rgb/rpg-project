...
CORRECTION_PATH = (
    SCRIPT_DIR / "attack_sword_directional_cycle_correction_v21_pass03.py"
)
BUILDER_PATH = (
    SCRIPT_DIR / "attack_sword_directional_cycle_builder_v21_pass03.py"
)
CONTACT_SHEET_NAME = "attack_sword_01_directional_cycle_v21.png"
BASE_WRITE_MANIFEST_PASS02 = pass02_adapter._write_manifest_v21_pass02


def _write_manifest_v21_pass03(
    ...
    if action is None:
        raise RuntimeError(
            "attack sword directional v21 pass03 manifest action is missing"
        )
    if action.get("directional_arm_correction_revision") != ARM_CLEARANCE_REVISION:
        raise RuntimeError(
            "attack sword directional v21 pass03 action metadata drifted"
        )

    payload["attack_sword_directional_cycle_v21_pass03"] = {
        "correction_pass": CORRECTION_PASS,
        "arm_clearance_revision": ARM_CLEARANCE_REVISION,
        ...
        "selected_correction_degrees": {
            "lift": SELECTED_LIFT_DEGREES,
            "sweep": SELECTED_SWEEP_DEGREES,
            "depth": SELECTED_DEPTH_DEGREES,
        },
    ...
    payload.setdefault("animation_contract", {}).update(
        {
            "attack_sword_01_current_stage": (
                "directional_full_cycle_v21_pass03"
            ),
            "attack_sword_01_left_onehand_arm_clearance_fixed": True,
...
def main() -> int:
    base_adapter.create_attack_sword_directional_cycle_actions_v21 = (
        create_attack_sword_directional_cycle_actions_v21_pass03
    )
    pass02_adapter._write_manifest_v21_pass02 = _write_manifest_v21_pass03
