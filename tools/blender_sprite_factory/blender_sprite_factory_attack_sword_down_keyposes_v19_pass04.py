...
CORRECTION_PATH = SCRIPT_DIR / "attack_sword_down_keyposes_correction_v19_pass04.py"
...
def _write_manifest_v19_pass04(
    context: object,
    run_dir: Path,
    run_id: str,
    blend_path: Path,
    ...
    payload["attack_sword_down_keyposes_v19_pass04"] = {
    ...
    payload.setdefault("animation_contract", {}).update(
        {
            "attack_sword_01_current_stage": "down_keyposes_v19_pass04",
...
def main() -> int:
    ...
    previous_adapter._write_manifest_v19_pass03 = _write_manifest_v19_pass04
