...
import blender_sprite_factory_head_v06 as previous_adapter
...
PREVIOUS_HEAD_PROFILE_PATH = SCRIPT_DIR / "head_profile_v06.py"
ACTIVE_HEAD_PROFILE_PATH = SCRIPT_DIR / "head_profile_v07.py"
_ORIGINAL_WRITE_RUN_MANIFEST = factory._write_run_manifest


def _build_head_and_hair_v07(context: factory.BuildContext) -> None:
    previous_adapter.load_head_detail_profile_v06 = load_head_detail_profile_v07
    previous_adapter._build_head_and_hair_v06(context)


def _write_run_manifest_v07(
    ...
    detail = load_head_detail_profile_v07(context.config.character_id)
...
def main() -> int:
    factory.load_head_profile = load_head_profile_v07
    factory._build_head_and_hair = _build_head_and_hair_v07
    factory._write_run_manifest = _write_run_manifest_v07
    return factory.main()
