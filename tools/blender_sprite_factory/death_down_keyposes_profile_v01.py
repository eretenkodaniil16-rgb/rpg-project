...
DEATH_03_BASE_POSES_V01 = (
    ...
    DeathDownPoseDeltaV01(
        ...
        pelvis_y=0.105,
        pelvis_z=-0.255,
        pelvis_roll_z_degrees=32.0,
        spine_pitch_x_degrees=-42.0,
        chest_yaw_z_degrees=38.0,
        head_pitch_x_degrees=-46.0,
        head_yaw_z_degrees=-18.0,
        thigh_left_x_degrees=-37.0,
        thigh_right_x_degrees=-16.0,
        shin_left_x_degrees=52.0,
        shin_right_x_degrees=24.0,
        foot_left_x_degrees=-14.0,
        foot_right_x_degrees=-5.0,
        upper_arm_left_x_degrees=34.0,
        upper_arm_left_y_degrees=-14.0,
        upper_arm_left_z_degrees=41.0,
        forearm_left_x_degrees=38.0,
        forearm_left_z_degrees=26.0,
        hand_left_x_degrees=16.0,
        upper_arm_right_x_degrees=-9.0,
        upper_arm_right_y_degrees=13.0,
        upper_arm_right_z_degrees=-39.0,
        forearm_right_x_degrees=26.0,
        forearm_right_z_degrees=-27.0,
        hand_right_x_degrees=14.0,
        cloth_left_x_degrees=-19.0,
        cloth_center_x_degrees=-14.0,
        cloth_right_x_degrees=-17.0,
    ),
    DeathDownPoseDeltaV01(
        frame=4,
        phase="ground_impact",
        ...
        pelvis_y=0.165,
        pelvis_z=-0.525,
        pelvis_roll_z_degrees=64.0,
        spine_pitch_x_degrees=-72.0,
        chest_yaw_z_degrees=66.0,
        head_pitch_x_degrees=-78.0,
        head_yaw_z_degrees=-26.0,
        thigh_left_x_degrees=-69.0,
        thigh_right_x_degrees=-28.0,
        shin_left_x_degrees=86.0,
        shin_right_x_degrees=43.0,
        foot_left_x_degrees=-32.0,
        foot_right_x_degrees=-11.0,
        upper_arm_left_x_degrees=58.0,
        upper_arm_left_y_degrees=-24.0,
        upper_arm_left_z_degrees=70.0,
        forearm_left_x_degrees=64.0,
        forearm_left_z_degrees=46.0,
        hand_left_x_degrees=31.0,
        hand_left_z_degrees=24.0,
        upper_arm_right_x_degrees=-18.0,
        upper_arm_right_y_degrees=22.0,
        upper_arm_right_z_degrees=-66.0,
        forearm_right_x_degrees=42.0,
        forearm_right_z_degrees=-45.0,
        hand_right_x_degrees=24.0,
        hand_right_z_degrees=-18.0,
        cloth_left_x_degrees=-38.0,
        cloth_center_x_degrees=-29.0,
    ...
    DeathDownPoseDeltaV01(
        ...
        pelvis_y=0.195,
        pelvis_z=-0.640,
        pelvis_roll_z_degrees=82.0,
        spine_pitch_x_degrees=-84.0,
        chest_yaw_z_degrees=76.0,
        head_pitch_x_degrees=-86.0,
        head_yaw_z_degrees=-30.0,
        thigh_left_x_degrees=-82.0,
        thigh_right_x_degrees=-36.0,
        shin_left_x_degrees=89.0,
        shin_right_x_degrees=51.0,
        foot_left_x_degrees=-39.0,
        foot_right_x_degrees=-16.0,
        upper_arm_left_x_degrees=68.0,
        upper_arm_left_y_degrees=-29.0,
        upper_arm_left_z_degrees=82.0,
        forearm_left_x_degrees=73.0,
        forearm_left_z_degrees=55.0,
        hand_left_x_degrees=38.0,
        hand_left_z_degrees=29.0,
        upper_arm_right_x_degrees=-24.0,
        upper_arm_right_y_degrees=28.0,
        upper_arm_right_z_degrees=-78.0,
        forearm_right_x_degrees=50.0,
        forearm_right_z_degrees=-53.0,
        hand_right_x_degrees=29.0,
        hand_right_z_degrees=-23.0,
        cloth_left_x_degrees=-46.0,
        cloth_center_x_degrees=-35.0,
        cloth_right_x_degrees=-42.0,
    ),
)
