...
Активный профиль `v03` уточняет только нижнюю часть уже проверенного
статического силуэта: стойку, разницу ног по глубине и поперечный объём
задней ткани. Корпус, руки, голова, лицо, камера, палитра и ключи Action
`walk_down` в этом проходе зафиксированы.

## Следующие расширения после принятия пилота

1. локально исправить пропорции proxy по `idle_down`;
2. заменить голову и волосы на каноничные меши;
