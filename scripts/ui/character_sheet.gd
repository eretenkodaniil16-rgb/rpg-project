...
func _build_ui() -> void:
	...
	future.text = "Экипировка и классовые способности появятся в следующих версиях."
	future.add_theme_font_size_override("font_size", 18)
...
func _refresh() -> void:
	...
	_summary.text = "Здоровье: %d / %d     Опыт: %d" % [_character.current_health, _character.maximum_health, _character.experience]
