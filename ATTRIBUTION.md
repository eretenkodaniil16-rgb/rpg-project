...
This project uses and adapts game-mechanics material from the **System Reference Document 5.2.1 (SRD 5.2.1)** by Wizards of the Coast LLC.

The SRD 5.2.1 material is available under the **Creative Commons Attribution 4.0 International License (CC BY 4.0)**.
